...
from .samples import (
    ...
    PUBKEY_HASH_COMPRESSED, PUBKEY_HASH_PAY2SH, PUBLIC_KEY_COMPRESSED,
    PUBLIC_KEY_UNCOMPRESSED, PUBLIC_KEY_X, PUBLIC_KEY_Y,
...
def test_address_to_public_key_hash():
    ...
    assert address_to_public_key_hash(BITCOIN_ADDRESS_PAY2SH) == PUBKEY_HASH_PAY2SH
